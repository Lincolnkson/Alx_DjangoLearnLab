...
@user_passes_test(CustomUser.has_perms('can_add_book', 'can_change_book', 'can_delete_book'))
@login_required
...
def is_admin(CustomUser):
    return CustomUser.userprofile.role == UserProfile.Admin
...
def is_member(CustomUser):
    return CustomUser.userprofile.role == UserProfile.Member
